...
sub OnItemContentChange()
    ...
    if content <> invalid
        ...
        if itemType = "APPOINTMENT"
            ...
            accentColor = "0xEC4899FF"
            bgColor = "0xEC489920"
            labelText = "PET VAX"
        else if itemType = "KIDS_TASK" or itemType = "CHORE"
            accentColor = "0x10B981FF"
            bgColor = "0x10B98120"
            labelText = "CHORE"
        else if itemType = "EVENT" or itemType = "KIDS_EVENT"
            accentColor = "0x6366F1FF"
            bgColor = "0x6366F120"
            labelText = "EVENT"
        else if itemType = "TASK" or itemType = "PET_TASK"
